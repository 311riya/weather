...
title = Label(root, text='Weather Detection And Forecast',fg='black',font=('times new roman',17,'bold','underline'),bg='lightpink')
label1=Label(root, text='Enter the city name:',font=('times new roman',15),bg='lightpink')
city_input=Entry(root,width=24,fg='black',font=12)
timelabel=Label(root,text='',font=('bold',14),fg='yellow')


btn_submit = Button(root, text='Get weather',width=10,font=('times new roman',13,'bold'),bg='black',fg='white',command=get_weather)
btn_forecast = Button(root, text='Weather forecast',width=14,font=('times new roman',13,'bold'),bg='black',fg='white',command=get_forecast)
btn_reset = Button(root,text='Reset',font=('times new roman',13,'bold'),bg='black',fg='white',command=reset)


label2 = Label(root, text="Temperature:",font=('times new roman',15),bg='lightpink')
label3 = Label(root, text="Pressure:",font=('times new roman',15),bg='lightpink')
label4 = Label(root, text="Humidity:",font=('times new roman',15),bg='lightpink')
label5 = Label(root, text="Wind:",font=('times new roman',15),bg='lightpink')
label6 = Label(root, text="Cloudiness:",font=('times new roman',15),bg='lightpink')
label7 = Label(root, text="Description:",font=('times new roman',15),bg='lightpink')
